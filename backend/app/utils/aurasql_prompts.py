...
- Only use tables and columns that exist in the provided schema context.
- If the request cannot be answered with the provided context, return sql as an empty string and explain that the request is not in the selected context.
...
Generate at least 12 questions. Use only tables and columns from the provided schema.
"""
