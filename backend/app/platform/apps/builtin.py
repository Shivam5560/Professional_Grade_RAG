...
BUILTIN_MANIFESTS = (
    ...
    AppManifest(
        id="data-analyst", version="2.0.0", name="Data Analyst Studio",
        ...
        backend_route_prefixes=("/api/v2/data-analyst",),
        backend_router_ids=("data-analyst-v2",),
        required_capabilities=(Capability.AUTH, Capability.WORKFLOWS, Capability.ARTIFACTS),
        required_permissions=("analysis:run",), required_env_keys=(),
        ...
        health_check_id="analysis", packaging_paths=("backend/app/studios/data_analyst", "backend/app/platform", "frontend/app/analysis"),
    ),
    AppManifest(
    ...
    AppManifest(
        id="career-studio", version="2.0.0", name="Career Studio",
        summary="Truth-preserving resume analysis, tailoring, generation, and review.",
        category="career", icon="briefcase-business", frontend_route="/career",
        backend_route_prefixes=("/api/v2/career",),
        backend_router_ids=("career-v2",),
        required_capabilities=(Capability.AUTH, Capability.WORKFLOWS, Capability.CAREER),
        required_permissions=("career:write",), required_env_keys=(),
        ...
        health_check_id="career", packaging_paths=("backend/app/studios/career", "backend/app/platform", "frontend/app/career"),
    ),
    AppManifest(
